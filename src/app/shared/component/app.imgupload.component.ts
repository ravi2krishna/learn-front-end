...
@Component({
  ...
  template: `  <div class="imgupload">
              ...
              <img  alt="placeholder" class="placeholder-image"[src]="placeholder" height="auto" width="50%"/>
              `,
  styles: [''],
  providers: [
    {provide: NG_VALUE_ACCESSOR, useExisting: AppImgUploadComponent, multi: true}
  ],
})
export class AppImgUploadComponent implements ControlValueAccessor {
